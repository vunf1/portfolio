!function(e){
  ...
  e('a.js-scroll-trigger[href*="#"]:not([href="#"])').click(function(){
    ...
    if((t=t.length?t:e("[name="+this.hash.slice(1)+"]")).length)
      return e("html, body").animate({scrollTop:t.offset().top},1e3,"easeInOutExpo"),!1}}),e(".js-scroll-trigger").click(function(){e(".navbar-collapse").collapse("hide")})
}(jQuery);
...
$(".loadDiv").click(function (event) {
 ...
 $(document).ready(function () {
  // Load content regardless of protocol (HTTP or HTTPS)
